        ...
        <div className="grid content-center justify-center h-full justify-items-center">
          <div className="w-10/12 text-center sm:w-11/12 md:w-40rem">
            <Fade duration={2000}>
              ...
              Pronto para assistir? Insira seu e-mail para criar ou reiniciar sua 
              assinatura.
              </h1>
              <div>
                <input
            ...
            <div className="lg:flex lg:items-center lg:w-9/12">
              <div>
                ...
                <h1 className="m-4 text-center text-stone-400 font-light lg:text-left lg:ml-8 lg:text-2xl lg:w-9/12">
                  Assista em smart TVs, PlayStation, Xbox, Chromecast, Apple TV, leitores de Blu-ray e muito mais.
                </h1>
              </div>
            ...
            <div className="flex flex-col-reverse lg:flex-row lg:items-center lg:w-9/12">
              ...
              <div>
                <h1 className="mx-4 mt-4 mb-6 text-4xl font-semibold text-center text-white lg:mt-0 lg:text-left lg:ml-8 lg:text-5xl xl:text-6xl">
                  Baixe seus conteúdos para assistir offline
                </h1>
                <h1 className="m-4 text-center text-stone-400 font-light lg:text-left lg:ml-8 lg:text-2xl lg:w-9/12">
                  Salve seus favoritos facilmente e sempre tenha algo para 
                  assistir.
                </h1>
              </div>
            </div>
          ...
          <div className="flex justify-center md:py-8">
            <div className="lg:flex lg:items-center lg:w-9/12">
              <div>
                ...
                <h1 className="m-4 text-center text-stone-400 font-light lg:text-left lg:ml-8 lg:text-2xl lg:w-9/12">
                  Transmita filmes e séries ilimitados no seu smartphone, tablet, 
                  notebook e TV.
                </h1>
              </div>
              <div className="flex justify-center">
          ...
          <div className="flex justify-center">
            <div className="flex flex-col-reverse lg:flex-row lg:items-center lg:w-9/12">
              ...
              <div>
                ...
                <h1 className="m-4 text-center text-stone-400 font-light lg:text-left lg:ml-8 lg:text-2xl lg:w-9/12">
                  Envie crianças em aventuras com seus personagens favoritos em 
                  um espaço feito só para elas, grátis com sua assinatura.
                </h1>
              </div>
            </div>
          </div>
