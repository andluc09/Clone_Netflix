              ...
              <div>
                ...
                <div className="flex justify-between cursor-pointer mb-4 md:mb-8">
                  ...
                  <img
                    onClick={() =>
                      updateProfilePic(
                        "https://i.pinimg.com/564x/86/2a/53/862a537a244d4f18264398ebd1a8873a.jpg"
                      )
                    }
                    className="w-16 h-16 rounded-md cursor-pointer"
                    src="https://i.pinimg.com/564x/86/2a/53/862a537a244d4f18264398ebd1a8873a.jpg"
                  />
                  <img
                    onClick={() =>
                      updateProfilePic(
                        "https://i.pinimg.com/564x/89/51/35/89513597910ab6ce4285402ab7c0e591.jpg"
                      )
                    }
                    className="w-16 h-16 rounded-md cursor-pointer"
                    src="https://i.pinimg.com/564x/89/51/35/89513597910ab6ce4285402ab7c0e591.jpg"
                  />
                  <img
                    onClick={() =>
                      updateProfilePic(
